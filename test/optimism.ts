...
describe("Optimism Synth Chef", function () {
    ...
    before(async function () {
        ...
        wrapper = await velodromeWrapperFactory.deploy("0xa132DAB612dB5cB9fC9Ac426A0Cc215A3423F9c9");
        ...
        chef = (await ChefFactory.deploy("0xa132DAB612dB5cB9fC9Ac426A0Cc215A3423F9c9",
            ...
            1, owner.getAddress())) as OptimismSynthChef;
    ...
    it("Withdraw", async function () {
        ...
        await chef.withdraw(PID, chef.stablecoin(), chef.getLPAmountOnFarm(PID), owner.getAddress(), 0);
