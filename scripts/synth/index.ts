...
export default async function deploy() {
    ...
    if(net != "tmat") {
        ...
        await (
            await SynthFactory.createSynth(synthInfo.tmat.chainId, synthInfo.tmat.chef, synthInfo.tmat.pid, synthInfo.tmat.stable)
        ).wait();
    ...
    if(net != "tftm") {
        ...
        await (
            await SynthFactory.createSynth(synthInfo.tftm.chainId, synthInfo.tftm.chef, synthInfo.tftm.pid, synthInfo.tftm.stable)
        ).wait();
        let synth = EntangleSynth__factory.connect(addr, owner);
        await (await synth.setPrice("2000000000000000000")).wait();
    }
    if(net != "tavax") {
        ...
        await (
            await SynthFactory.createSynth(synthInfo.tavax.chainId, synthInfo.tavax.chef, synthInfo.tavax.pid, synthInfo.tavax.stable)
        ).wait();
        let synth = EntangleSynth__factory.connect(addr, owner);
        await (await synth.setPrice("2000000000000000000")).wait();
    }
    if(net != "tbsc") {
        ...
        await (
            await SynthFactory.createSynth(synthInfo.tbsc.chainId, synthInfo.tbsc.chef, synthInfo.tbsc.pid, synthInfo.tbsc.stable)
        ).wait();
        let synth = EntangleSynth__factory.connect(addr, owner);
        await (await synth.setPrice("2000000000000000000")).wait();
    }
    if(net != "top") {
        ...
        await (
            await SynthFactory.createSynth(synthInfo.top.chainId, synthInfo.top.chef, synthInfo.top.pid, synthInfo.top.stable)
        ).wait();
        let synth = EntangleSynth__factory.connect(addr, owner);
        await (await synth.setPrice("2000000000000000000")).wait();
    }
    if(net != "tarb") {
        ...
        await (
            await SynthFactory.createSynth(synthInfo.tarb.chainId, synthInfo.tarb.chef, synthInfo.tarb.pid, synthInfo.tarb.stable)
        ).wait();
        let synth = EntangleSynth__factory.connect(addr, owner);
        await (await synth.setPrice("2000000000000000000")).wait();
    }
